...
async function main() {
  ...
  // ──────────────────────────────────────────────
  const pwHash = await bcrypt.hash('MbgTrust@2026!', SALT);
  ...
  console.log('  Super Admin → email: superadmin@mbgtrust.go.id  | sandi: MbgTrust@2026!');
  console.log('  Admin SPPG  → email: admin.sppg1@mbgtrust.go.id      | sandi: MbgTrust@2026!');
  console.log('  Siswa       → nik_nisn: 100012026                 | sandi: MbgTrust@2026!');
}
