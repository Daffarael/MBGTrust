                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildWeightSliderWithDesc(
                      '1. Penilaian Rasa (Benefit ↑)',
                      'Tingkat kelezatan bumbu & cita rasa makanan menurut ulasan siswa (semakin tinggi semakin baik).',
                      _weightRasa,
                      (val) => setModalState(() => _weightRasa = val),
                    ),
                    _buildWeightSliderWithDesc(
                      '2. Tingkat Kesukaan (Benefit ↑)',
                      'Tingkat kepuasan & preferensi penerimaan siswa terhadap variasi menu (semakin tinggi semakin baik).',
                      _weightKesukaan,
                      (val) => setModalState(() => _weightKesukaan = val),
                    ),
                    _buildWeightSliderWithDesc(
                      '3. Kecukupan Porsi (Benefit ↑)',
                      'Kesesuaian volume porsi makanan dengan kebutuhan gizi & kenyang siswa (semakin tinggi semakin baik).',
                      _weightPorsi,
                      (val) => setModalState(() => _weightPorsi = val),
                    ),
                    _buildWeightSliderWithDesc(
                      '4. Tingkat Konsumsi Makanan (Benefit ↑)',
                      'Persentase rata-rata makanan yang berhasil dihabiskan siswa (semakin tinggi semakin baik).',
                      _weightWaste,
                      (val) => setModalState(() => _weightWaste = val),
                    ),
                    _buildWeightSliderWithDesc(
                      '5. Tingkat Penerimaan MBG (Benefit ↑)',
                      'Persentase siswa yang mengonfirmasi kesediaan & menyukai porsi MBG (semakin tinggi semakin baik).',
                      _weightPenolakan,
