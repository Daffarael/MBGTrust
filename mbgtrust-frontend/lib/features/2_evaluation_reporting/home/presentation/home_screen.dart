...
import '../../../1_user_management/auth/presentation/providers/auth_provider.dart';
import '../../../1_user_management/auth/presentation/profile_screen.dart';
import '../../../2_evaluation_reporting/evaluation/presentation/gamification_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            // 1. TOP HEADER GREEN GRADIENT (Sesuai Referensi MyUnand)
            Container(
            ...
            // 2. KARTU METRIK TERAPUNG OVERLAPPING GRADIENT & BODY (Persis MyUnand IPK/IPS/TSSI Card)
            Transform.translate(
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text(
                              _hasEvaluatedToday ? '2.3 kg' : '1.8 kg',
                              style: const TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: const [
                                  ...
                                  Icon(Icons.chevron_right_rounded, color: Colors.white70, size: 11),
                                ],
                              ),
                            ],
                          ),
